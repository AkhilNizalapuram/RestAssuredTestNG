...
public class TimeoutAttributes {
    ...
    @Test(timeOut=200)
    public void retriveEmployee() throws InterruptedException {
    ...
    @Test(description="This is post Method")
    ...
    @Test(description="This is update Method")
